            ...
            <div style = {inlineStyle.formDetails}>
                <form>
                    ...
                    <div style = {inlineStyle.textCenter}>
                        <div style = {{...inlineStyle.reducedFont, ...inlineStyle.forgotPwd}}>By clicking on signup, you agree to our <NavLink style={inlineStyle.reducedFont} to="/terms"> Privacy Policy </NavLink>and <NavLink to="/terms" style={inlineStyle.reducedFont}>Terms and Conditions</NavLink></div>
                    </div>

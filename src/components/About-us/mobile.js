        ...
        <DIV>
            <div className="about-card">
                ...
                <div className="center">
                    ...
                    <Button onClick={() => props.navigate('/about/who-we-are')} label="CHECK US OUT"/>
                </div>
            </div>
            <div className="about-card">
                <div className="about-img">
                ...
                <div className="center">
                    ...
                    <Button onClick={() => props.navigate('/about/events')} label="SURF"/>
                </div>
            </div>
            <div className="about-card">
                <div className="about-img">
                ...
                <div className="center">
                    ...
                    <Button onClick={() => props.navigate('/about/brands')} label="DISCOVER HERE"/>
                </div>
            </div>
        </DIV>
    </div>

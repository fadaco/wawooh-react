             ...
             <RowHolder>
                <Col3 style={{...watchStyle.innerContainer, background: '#f3f3f3'}}>
                    <div className="styleImage">
                        ...
                        <div style={{background: '#fff',  padding: '10px 3px 3rem'}}>
                            <div style={{display:'flex', justifyContent:'space-around',paddingBottom:'10px'}}>
                                <div style={{flex:'0 0 50%'}}><span>Budget</span></div>
                                <div style={{color:'rgb(100,210,100)'}}>{NairaSign}{properties.budget !== '' ? numberWithCommas(properties.budget) : 0}</div>
                            </div>
                            <div style={{display:'flex', justifyContent:'space-evenly',}}>
                                <div style={{flex:'0 0 50%'}}><span>Expected Delivery</span></div>
                                <div>
                                    {
                ...
                <Col7 style={watchStyle.innerContainer}>
                    ...
                    <div className="first-part" style={{display: (presentPage ? 'block' : 'none')}}>
                        ...
                        <div className="formGroup">
                            ...
                            <select name="categoryId" value={props.gender} className="formControl" onChange={_changeValues}>
                        ...
                        <div className="formGroup">
                            ...
                            <RowHolder>
                                <Col3 style={{paddingLeft:'0'}} className="fitnessType">
